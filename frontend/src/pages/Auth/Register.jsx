...
//           tier: selectedPackage, // Adjust key if needed
//         };
...
//   // Rest of your packages array and JSX remains the same, just update the form inputs:
//   return (
//     <div className="flex h-screen bg-[#050813] text-white">
//       {/* Toast Container */}
//       <ToastContainer
//         position="top-center" // Position toast above the header
//         autoClose={3000}
